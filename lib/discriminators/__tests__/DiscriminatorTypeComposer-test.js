  ...
  describe('class methods', () => {
    ...
    describe('addFields(newFields)', () => {
      ...
      it('should have exactly plus two fields added to childTC fields', () => {
        expect(droidTC.getFieldNames()).toEqual([...characterDTC.getFieldNames(), ...droidSpecificFields]);
        expect(personTC.getFieldNames()).toEqual([...characterDTC.getFieldNames(), ...personSpecificFields]);
      });
    });
