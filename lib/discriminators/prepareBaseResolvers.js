...
const {
  GraphQLList,
  GraphQLNonNull
} = graphql; // change type on DKey generated by composeWithMongoose
...
export function prepareBaseResolvers(baseTC) {
    ...
    if (EMCResolvers.hasOwnProperty(resolverName) && baseTC.hasResolver(resolverName)) {
      ...
      switch (resolverName) {
        ...
        case EMCResolvers.connection:
          ...
          .getTypeComposer().getFieldOTC('edges').clone(`${baseTC.getTypeName()}Edge`);
